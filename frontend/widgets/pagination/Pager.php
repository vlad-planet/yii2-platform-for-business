...
class Pager extends Widget
{
	 ...
	 */
	public $options = ['class' => 'pagination d-flex justify-content-center align-content-center'];
	/**
	 ...
	 */
	public $nextPageLabel = '<i class="fa fa-caret-square-o-right fa-lg" aria-hidden="true"></i>';
	/**
	 * @var string|bool the text label for the "previous" page button. Note that this will NOT be HTML-encoded.
	 * If this property is false, the "previous" page button will not be displayed.
	 */
	public $prevPageLabel = '<i class="fa fa-caret-square-o-left fa-lg" aria-hidden="true"></i>';
	/**
	...
	protected function renderPageButtons()
	{
		...
		$buttons[] = '<span class="count">' . ($currentPage + 1) . ' из ' . $pageCount . '</span>';
